...
class MagnumConan(ConanFile):
    ...
    exports = ["COPYING"]
    exports_sources = ["CMakeLists.txt", "src/*", "!src/*/*/Test", "package/conan/*", "modules/*", "toolchains/*"]
    generators = "cmake"
    ...
    default_options = {
        ...
        "with_emscriptenapplication": False,
    ...
    requires = (
        "corrade/{}@inexorgame/testing".format(version) # both must be updated in lock-step: corrade and magnum
    )
        ...
        if tools.os_info.is_linux:
            if tools.os_info.with_apt:
                ...
                if self.settings.arch == "x86":
                    ...
                    self.output.warn("emscripten used.. Linux system requirements installation may not be necessary/sufficient.")
                    arch_suffix = ""
